...
// MARK: - TokenResponse AutoHashable
extension TokenResponse: Hashable {
    public var hashValue: Int {
        return combineHashes([
            token.hashValue,
            tokenSecret.hashValue,
            callbackConfirmed.hashValue,
            0])
    }
}
// MARK: - TwitterUser AutoHashable
extension TwitterUser: Hashable {
    public var hashValue: Int {
        return combineHashes([
            id.hashValue,
            screenName.hashValue,
            name.hashValue,
            profileImage?.hashValue ?? 0,
            0])
    }
}
